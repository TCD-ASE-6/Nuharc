...
describe("user test cases", function () {
  ...
  describe("user post", () => {
    it("should FAIL: give error saying different passwords", async () => {
      const fetch = require("node-fetch");
      const assert = require("assert");
      var user = {
        name: "olivertest6",
  ...
  describe("user post", () => {
    it("should FAIL: create new user", async () => {
      const fetch = require("node-fetch");
      const assert = require("assert");
      var user = {
        name: "olivertest5",
  ...
  describe("user post", () => {
    it("should FAIL: give error getting user with wrong password", async () => {
      const fetch = require("node-fetch");
      const assert = require("assert");
      var user = {
        email: "ok5@xyz.com",
  ...
  describe("user post", () => {
    it("should FAIL: give 200 when logging in with correct details", async () => {
      const fetch = require("node-fetch");
      const assert = require("assert");
      var user = {
        email: "ok5@xyz.com",
